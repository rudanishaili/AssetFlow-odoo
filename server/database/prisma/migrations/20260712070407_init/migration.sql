/*
  ...
  - You are about to drop the `asset_requests` table. If the table is not empty, all the data it contains will be lost.
  ...
  - You are about to drop the `warranties` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `asset_assignments` DROP FOREIGN KEY `asset_assignments_assetId_fkey`;

-- DropForeignKey
ALTER TABLE `asset_assignments` DROP FOREIGN KEY `asset_assignments_assignedById_fkey`;

-- DropForeignKey
ALTER TABLE `asset_assignments` DROP FOREIGN KEY `asset_assignments_assigneeId_fkey`;

-- DropForeignKey
ALTER TABLE `asset_images` DROP FOREIGN KEY `asset_images_assetId_fkey`;

-- DropForeignKey
ALTER TABLE `asset_requests` DROP FOREIGN KEY `asset_requests_categoryId_fkey`;

-- DropForeignKey
ALTER TABLE `asset_requests` DROP FOREIGN KEY `asset_requests_requesterId_fkey`;

-- DropForeignKey
ALTER TABLE `asset_requests` DROP FOREIGN KEY `asset_requests_reviewedById_fkey`;

-- DropForeignKey
ALTER TABLE `assets` DROP FOREIGN KEY `assets_categoryId_fkey`;

-- DropForeignKey
ALTER TABLE `assets` DROP FOREIGN KEY `assets_vendorId_fkey`;

-- DropForeignKey
ALTER TABLE `audit_logs` DROP FOREIGN KEY `audit_logs_userId_fkey`;

-- DropForeignKey
ALTER TABLE `maintenances` DROP FOREIGN KEY `maintenances_assetId_fkey`;

-- DropForeignKey
ALTER TABLE `notifications` DROP FOREIGN KEY `notifications_userId_fkey`;

-- DropForeignKey
ALTER TABLE `purchase_details` DROP FOREIGN KEY `purchase_details_assetId_fkey`;

-- DropForeignKey
ALTER TABLE `users` DROP FOREIGN KEY `users_departmentId_fkey`;

-- DropForeignKey
ALTER TABLE `warranties` DROP FOREIGN KEY `warranties_assetId_fkey`;
